...
function recognize(array $input) {
    ...
    for($x=0;$x<strlen($input[0])/3;$x++) {
        ...
        //recognize 0
        if($_SESSION['number'.$x][0]==" _ " && $_SESSION['number'.$x][1]=="| |" && $_SESSION['number'.$x][2]=="|_|") {
            $returnString.="0";
        }

        //recognize 1
        elseif($_SESSION['number'.$x][0]=="   " && $_SESSION['number'.$x][1]=="  |" && $_SESSION['number'.$x][2]=="  |") {
            $returnString.="1";
        }

        //recognize 2
        elseif($_SESSION['number'.$x][0]==" _ " && $_SESSION['number'.$x][1]==" _|" && $_SESSION['number'.$x][2]=="|_ ") {
            $returnString.="2";
        }
        ...
        //recognize 4
        elseif($_SESSION['number'.$x][0]=="   " && $_SESSION['number'.$x][1]=="|_|" && $_SESSION['number'.$x][2]=="  |") {
            $returnString.="4";
        }
        ...
        //recognize 7
        elseif($_SESSION['number'.$x][0]==" _ " && $_SESSION['number'.$x][1]=="  |" && $_SESSION['number'.$x][2]=="  |") {
            $returnString.="7";
        }
